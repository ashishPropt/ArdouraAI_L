    ...
    <div className="min-h-screen bg-gradient-to-br from-ardoura-950 via-ardoura-900 to-slate-900 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-ardoura-300 mt-1 text-sm">Start building apps with AI today</p>
        </div>

        <div className="bg-ardoura-900/50 border border-ardoura-800/50 rounded-2xl p-8 backdrop-blur-sm">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-sm font-medium text-ardoura-200 mb-1.5">Full name</label>
              <input
                type="text"
                value={form.name}
          ...
          <p className="text-center text-ardoura-400 text-sm mt-6">
            ...
            <Link href="/login" className="text-ardoura-300 hover:text-white transition-colors font-medium">
              Sign in
            </Link>
          </p>
        </div>
